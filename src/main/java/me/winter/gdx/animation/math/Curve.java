...
public class Curve {
	...
	public float interpolate(float a, float b, float value) {
		switch(type) {
			...
			case CUBIC:
				return cubic(a, linear(a, b, constraints.c1), linear(a, b, constraints.c2), b,
						value);
			case QUARTIC:
				return quartic(a, linear(a, b, constraints.c1), linear(a, b, constraints.c2),
						linear(a, b, constraints.c3), b, value);
			case QUINTIC:
				return quintic(a, linear(a, b, constraints.c1), linear(a, b, constraints.c2),
						linear(a, b, constraints.c3), linear(a, b, constraints.c4), b, value);
			case BEZIER:
